...
export default function Two()
{
  ...
  return(
    <div>
      ...
      <br/>
      <br/>
      <div style={{border: "2px solid black", width: "12%", backgroundColor: "#28242c", padding: "2px", margin: "auto"}}>
        <h3 style= {{color: "white", textAlign: "center"}}>Sort By:</h3>
        <select style={{marginLeft:"8px", marginBottom: "5px"}} onChange={(e) => setSortType(e.target.value)}>
