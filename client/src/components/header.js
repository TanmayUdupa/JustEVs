                ...
                <div id = "container">
                    <div className = "row">
                        ...
                        <div className = "col-sm-4">
                            ...
                            <h1 style = {{marginTop: "10px"}}>JustEVs</h1>
                            </NavLink>
                        </div>
                        <div className = "col-sm-4">
                            <div id = "login">
                            {user && (
                                ...
                                {!user && (
                                <nav className="navbar navbar-expand-sm bg-dark justify-content-center navbar-fixed-top navbar-dark" style = {{width: 170, marginTop: "10px"}}>
